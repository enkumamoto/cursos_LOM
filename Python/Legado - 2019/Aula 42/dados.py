'''
dados que serão usados para mapeamento
'''
...
alunos = [
    {'nome': 'Eiji', 'idade': 12},
    {'nome': 'Ananda', 'idade': 43},
    {'nome': 'Eduarda', 'idade': 65},
    {'nome': 'Ana Carolinha', 'idade': 14},
    {'nome': 'Eiji Júnior', 'idade': 17},
    {'nome': 'Zezinho', 'idade': 19},
    {'nome': 'Marcos', 'idade': 25},
    {'nome': 'Teobaldo', 'idade': 32},
    {'nome': 'Marcondes', 'idade': 23},
    {'nome': 'Tonhão', 'idade': 59},
]
