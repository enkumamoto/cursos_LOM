...
def encontra_1_duplicado(param_lista_de_inteiros):
    num_checks = set()
    primeiro_duplicado = -1

    for num in param_lista_de_inteiros:
        if num in num_checks:
...
for lists in lista_de_listas_de_inteiros:
    print (lists, encontra_1_duplicado(lists))